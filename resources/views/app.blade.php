  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand  " style="font-weight:bold; " href="/"><img src="{{ asset('images/gallery/AQ-new.png')}}" height="45"  alt="logo" /> Aquarius IT SV</a>
          <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"> </span></button>
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
              <li class="nav-item px-2"><a class="nav-link" aria-current="page" id="inicio" href="/">Inicio</a></li>
              <li class="nav-item px-2"><a class="nav-link" id="servicios" href="/servicios">Servicios</a></li>
              <li class="nav-item px-2"><a class="nav-link" id="nosotros" href="/sobre-nosotros">Sobre Nosotros</a></li>
              <li class="nav-item px-2"><a class="nav-link" id="proyectos" href="/proyectos">Proyectos</a></li>
            </ul>
           
            <a class="btn btn-primary order-1 order-lg-0 ms-lg-3 text-black" id="contacto" href="/contacto">Contacto</a>
