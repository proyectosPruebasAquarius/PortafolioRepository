            ...
            <div class="container">
              {{-- <div class="row justify-content-center">
                <div class="col-md-8 col-lg-5 text-center mb-3">
                  ...
                  <h2>Los mejores servicios para ti</h2>
                </div>
              </div> --}}
                  ...
                  <div class="card h-100 px-lg-5 card-span">
                    <div class="card-body d-flex flex-column {{-- justify-content-around --}}">
                      ...
                      <div class="text-center my-5">
                        <div class="d-grid">
                          <a type="button" href="{{ url('/contacto') }}" class="btn btn-outline-primary" type="submit">Saber mas </a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-4 pt-4 px-md-2 px-lg-3">
                  <div class="card h-100 px-lg-5 card-span">
                    <div class="card-body d-flex flex-column {{-- justify-content-around --}}">
                      ...
                      <div class="text-center my-5">
                        <div class="d-grid">
                          <a type="button" href="{{ url('/contacto') }}" class="btn btn-primary hover-top btn-glow border-0" type="submit">Saber mas</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card h-100 px-lg-5 card-span">
                    <div class="card-body d-flex flex-column {{-- justify-content-around --}}">
                      <div class="text-center pt-5"><i class="fas fa-headset text-danger" style="font-size:86px;"></i>
                        <h5 class="my-4">Asesoría sobre hardware.</h5>
                      </div>
                      <p class="text-justify">
